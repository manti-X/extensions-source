...
class PublisherFilter :
    SelectFilter(
        ...
        arrayOf(
            ...
            Pair("Mahjong Pros", "mahjong-pros"),
            ...
            Pair("Starts Publishing Corporation (MangaPlaza)", "starts-publishing-corporation-mp"),
            Pair("TAIYOHTOSHO Co., Ltd.", "taiyohtosho-co-ltd"),
            Pair("Titan Manga", "titan-manga"),
