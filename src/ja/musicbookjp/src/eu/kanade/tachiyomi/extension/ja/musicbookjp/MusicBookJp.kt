...
abstract class MusicBookJp :
    ...
    override suspend fun getPageList(chapter: SChapter): List<Page> {
        ...
        return List(params.last().lastPage) { i ->
            val coordinates = params.first { i < it.lastPage }.coordinates
            Page(i, imageUrl = "${display.layoutUrl}/${(i + 1).toString().padStart(5, '0')}.jpg#$coordinates")
        }
    }
